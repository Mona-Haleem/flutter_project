...
import 'lab8/cubit/products_cubit.dart';
import 'lab8/dio/api_provider.dart';
import 'lab8/home_screen.dart'
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => ProductsCubit(ApiProvider())..fetchProducts(),
        ),
      ],
      child: MaterialApp(
        title: 'Flutter Demo',
